...
class AccountTaxGroup(models.Model):
    ...
    l10n_py_tribute_set_code = fields.Selection([
        ...
        ('99', '99 - Others'),
    ], string='Tribute SET Code', index=True, readonly=True)
    # values from http://www.afip.gob.ar/fe/documentos/OperacionCondicionIVA.xls
    l10n_py_vat_set_code = fields.Selection([
        ('0', 'Not Applicable'),
        ('1', 'Untaxed'),
        ('2', 'Exempt'),
        ('3', '0%'),
        ...
        ('8', '5%'),
        ('9', '2,5%'),
    ], string='VAT SET Code', index=True, readonly=True)
